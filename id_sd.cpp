...
//              
static void SD_L_ALStopSound(void)
{
    alSound = 0;
    alOut(alFreqH + 0, 0);
}
...
//
static void SD_L_ShutDevice(void)
{
    switch (SoundMode)
    {
        case sdm_PC:
...
//
///////////////////////////////////////////////////////////////////////////
static void SD_L_CleanDevice(void)
{
...
///////////////////////////////////////////////////////////////////////////
//
//      SD_L_StartDevice() - turns on whatever device is to be used for sound fx
//
///////////////////////////////////////////////////////////////////////////
static void SD_L_StartDevice(void)
{
    switch (SoundMode)
    {
        case sdm_AdLib:
