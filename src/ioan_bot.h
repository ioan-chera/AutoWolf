...
class BotMan
{
   ...
   bool secretVerify(int tx, int ty, int txofs, int tyofs, Boolean8 knifeinsight, bool alreadyVerifying);
	Boolean8 ObjectOfInterest(int dx, int dy,
                                    Boolean8 knifeinsight = false, bool whileVerifyingSecrets = false);
