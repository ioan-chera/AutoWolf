...
#define ENDSTR4SPEAR "Hey, quit or play,\n" YESBUTTONNAME " or " NOBUTTONNAME ":\nit's your choice."
#define ENDSTR5SPEAR "Sure you don't want to\nwaste a few more\nproductive hours?"
#define ENDSTR6SPEAR "I think you had better\nplay some more. Please\npress " NOBUTTONNAME "...please?"
#define ENDSTR7SPEAR "If you are tough, press " NOBUTTONNAME ".\nIf not, press " YESBUTTONNAME " daintily."
#define ENDSTR8SPEAR "I'm thinkin' that\nyou might wanna press " NOBUTTONNAME "\nto play more. You do it."
#define ENDSTR9SPEAR "Sure. Fine. Quit.\nSee if we care.\nGet it over with.\nPress " YESBUTTONNAME "."
// #else
