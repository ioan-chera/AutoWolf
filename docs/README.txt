...
For Mac OS X 10.7 and later, use the Xcode project. You'll need static libraries of SDL,
...
better used in the Eternity Engine Doom port project. It implies using a special Makefile
